...
public class DynamicReportBuilder {
  ...
  private final String themeColorHexCode;

  public DynamicReportBuilder(JasperDesign jasperDesign, int numColumns, String themeColorHexCode) {
    this.jasperDesign = jasperDesign;
    this.numColumns = numColumns;
    this.themeColorHexCode = themeColorHexCode;
  }
  ...
  public void addDynamicColumns(List<Integer> currencyFieldIndexes) throws JRException {
    ...
    for (int i = 0, j = 0; i < numColumns; i++) {
      ...
      //colHeaderField.setBackcolor(new Color(128, 0, 128));
      colHeaderField.setBackcolor(Color.decode(this.themeColorHexCode));
  ...
  private void designTextBox(JRLineBox box) {
    ...
    box.setRightPadding(Integer.valueOf(5));
  }
}
